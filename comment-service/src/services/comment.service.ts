...
export class CommentService {
  public async create(authorId: string, authorUsername: string, input: { postId: string; parentId: string | null; body: string; replyToUserId: string | null }) {
    if (input.parentId) {
  ...
  public listByPost(postId: string) {
  ...
  public applyVote(targetType: string, targetId: string, delta: number): Promise<void> {
